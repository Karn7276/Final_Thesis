...
class inferThread(threading.Thread):
    ...
    def run(self):
        ...
        while(True):
            ...
            print(frame.shape)
            result, use_time = self.yolov5_wrapper.infer(frame)
...
class ImagePublisher(Node):
  ...
  def __init__(self):
    ...
    categories = ["Speed limit (20km/h)"," Speed limit (30km/h)","Speed limit (50km/h)", "Speed limit (60km/h)","Speed limit (70km/h)","Speed limit (80km/h)",
